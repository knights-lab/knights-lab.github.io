...
| {::nomarkdown}<img src="/images/profile.png" alt="Dan Knights" width="200" /> | {::nomarkdown}<h2>Dr. Dan Knights, Principal Investigator​</h2> |
...
| | |
| {::nomarkdown}<img src="/images/suziehoops.png" alt="Suzie Hoops" width="200" /> | {::nomarkdown}<h2>Suzie Hoops, Ph.D. Student</h2> |
